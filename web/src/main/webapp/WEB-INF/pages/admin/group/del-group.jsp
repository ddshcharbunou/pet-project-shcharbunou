        ...
        <c:forEach var="group" items="${requestScope.groups}">
            <li>
                <div class="group__card">
                    ...
                    <a href="<c:url value="/admin/group/control/delete/${group.id}/${sessionScope.page}"/>">
                        <button class="group__card__button" type="button">Удалить</button>
                    </a>
                </div>
            </li>
        </c:forEach>
...
<c:if test="${sessionScope.page == 1}">
    <c:choose>
        ...
        <c:when test="${requestScope.pagesNumber != 1}">
            <button class="pagination__left__button__non__active" type="button">&#5130</button>
            <a href="<c:url value="/admin/group/control/del-group/${sessionScope.page + 1}"/>">
